...
int main(){
    ...
    */
    ...
    while(parameters[0] <= 0){
        printf("Ingrese un numero valido de memoria total(mayor a 0): \n");
        scanf("%d", &parameters[0]);
    }
    printf("Ingrese la memoria minima: \n");
    scanf("%d", &parameters[1]);
    while(parameters[1] <= 0){
        printf("Ingrese un numero valido de memoria minima(mayor a 0): \n");
        scanf("%d", &parameters[1]);
    }
    printf("Ingrese el Quantum: \n");
    scanf("%d", &parameters[2]);
    while(parameters[2] <= 0){
        printf("Ingrese un numero valido de Quantum(mayor a 0): \n");
        scanf("%d", &parameters[2]);
    }
    ...
    printf("Se han recibido los parametros del sistema!\n");
    sleep(1);
    ...
    while(parameters[4] <= 0){
        printf("Ingrese un numero valido de tiempo de llegada(mayor a 0 ): \n");
        scanf("%d", &parameters[4]);
    }
    ...
    while(parameters[6] <= 0){
        printf("Ingrese un numero valido de memoria requerida (mayor a 0): \n");
        scanf("%d", &parameters[6]);
    }

    printf("Ingrese el minimo de memoria requerida: \n");
    scanf("%d", &parameters[7]);
    while(parameters[7] <= 0 || parameters[7] >= parameters[6]){
        printf("Ingrese un numero valido de memoria requerida (mayor a 0 y menor al maximo de memoria requerida): \n");
        scanf("%d", &parameters[7]);
    }
